...
# In this case we will have to add a new feature to the system: a logger.
# This logger will save a file called 'log.txt' with the following information:
# - Date and time of the transaction
# - Function Name
# - Function Arguments
# - Value returned by the function
# If the file already exists, the logger should append the new information to the file.
# Each entrance in the log file should be in a new line.
