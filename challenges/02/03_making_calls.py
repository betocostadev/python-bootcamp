...
# Cada chamada terá uma duração em minutos e o custo será deduzido do saldo do usuário, suponha o custo de $0.10
# por minuto. Você pode criar um método fazer_chamada que vai permitir que o usuário faça a chamada,
# ele vai receber o destinatario e duracao como parâmetros.
# Calcule o custo da chamada usando o método 'custo_chamada' do objeto 'plano', além de adicionar o método
# deduzir_saldo para deduzir o valor do saldo do plano e depois retorne uma mensagem adequada como mostra no
# exemplo a baixo.
...
# Classe UsuarioPrePago, aqui vemos a herança onde UsuarioPrePago herda os atributos e métodos
# da classe UsuarioTelefone:
