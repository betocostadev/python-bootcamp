# Desafio
# Imagine que você trabalha para uma empresa de telecomunicações e é responsável por
# validar se um número de telefone fornecido pelo cliente está em um formato correto.
...
def validate_numero_telefone(phone_number):
    ...
    # TODO: Defina um padrão de expressão regular (regex) para validar números de telefone no
    # formato (XX) 9XXXX-XXXX:

    pattern = r"^\(\d{2}\) 9\d{4}-\d{4}$"
    IS_VALID = "Número de telefone válido."
    IS_INVALID = "Número de telefone inválido."
    # A função 're.match()' para verifica se o padrão definido corresponde ao número de telefone fornecido.
    # O 're.match()' retorna um objeto 'match' se houver correspondência no início da string, caso contrário,
    # retorna 'None'.
...
# TODO: Chame a função 'validate_numero_telefone()' com o número de telefone
# fornecido como argumento e armazene o resultado retornado na variável 'result'.
